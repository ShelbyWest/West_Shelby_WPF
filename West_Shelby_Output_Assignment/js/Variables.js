...
console.log("I have " + anyPets+ "dogs, all Boxers"); //Logging and concatenating the number variable
console.log("My favorite band is a Korean band called " + favoriteMusic + "."); //Logging and concatenating the first string variable
